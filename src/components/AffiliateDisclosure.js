  ...
  return (
    <div role="region" aria-label="Affiliate disclosure" style={{
      ...
      <div style={{
        ...
        fontFamily: 'var(--font-dm-sans), DM Sans, sans-serif', fontSize: '12.5px',
        color: 'rgba(255,255,255,0.9)', lineHeight: 1.5,
      }}>
        <Star size={13} fill="#FFD24A" style={{ color: '#FFD24A', flexShrink: 0 }} />
        <p style={{ flex: 1, margin: 0 }}>
          <strong style={{ color: '#FFFFFF' }}>Affiliate disclosure:</strong>{' '}
          We earn commission from qualifying Amazon purchases. Prices &amp; availability are accurate as of the displayed update date.
        </p>
        <button
          onClick={dismiss}
          ...
          style={{
            ...
            color: 'rgba(255,255,255,0.75)', padding: '4px', display: 'flex',
