  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0A0E1A', overflowX: 'hidden' }}>
              ...
              return (
                <div key={i} style={{ display: 'flex' }}>
                  {DEALS.map(function(d) {
                    ...
                    return (
                      <span key={d.id} style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '12px', fontWeight: 500, color: '#94A3B8', whiteSpace: 'nowrap', padding: '0 28px', borderRight: '1px solid rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', gap: '8px' }}>
                        {d.shortName}
      ...
      <section style={{ maxWidth: '1280px', margin: '0 auto', padding: '72px 24px 64px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '64px', alignItems: 'center' }} className="mobile-stack">
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '20px' }}>
              ...
              <span style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '11px', fontWeight: 700, letterSpacing: '0.14em', textTransform: 'uppercase', color: '#00D084' }}>
                Updated weekly · {DEALS.length} live deals
              </span>
            </div>
            <h1 className="fade-up fade-up-1" style={{ fontFamily: 'DM Serif Display, serif', fontSize: 'clamp(42px, 6vw, 76px)', color: '#F0F4FF', marginBottom: '24px', letterSpacing: '-0.02em', lineHeight: 1.05 }}>
              Never<br />
              <span style={{ color: '#00D084' }}>overpay</span><br />
              again.
            </h1>
            <p className="fade-up fade-up-2" style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '18px', color: '#94A3B8', lineHeight: 1.7, marginBottom: '36px', maxWidth: '440px' }}>
            ...
            <div className="fade-up fade-up-3" style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
              <Link href="/browse" style={{ background: '#00D084', color: '#0A0E1A', fontFamily: 'DM Sans, sans-serif', fontSize: '13px', fontWeight: 700, letterSpacing: '0.06em', textTransform: 'uppercase', padding: '13px 28px', borderRadius: '8px', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
                Browse All Deals <ChevronRight size={16} />
              </Link>
              <Link href="/guides" style={{ background: 'transparent', color: '#F0F4FF', fontFamily: 'DM Sans, sans-serif', fontSize: '13px', fontWeight: 600, letterSpacing: '0.06em', textTransform: 'uppercase', padding: '12px 28px', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.14)', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
                Buying Guides
              </Link>
            </div>
          ...
          <div className="hide-mobile fade-up fade-up-2">
            <div style={{ background: 'linear-gradient(135deg, rgba(0,208,132,0.1) 0%, rgba(59,130,246,0.06) 100%)', borderRadius: '20px', padding: '28px', border: '1px solid rgba(0,208,132,0.15)' }}>
              <p style={{ fontFamily: 'DM Sans, sans-serif', fontSize: '11px', fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase', color: '#475569', marginBottom: '16px' }}>This week's top deals</p>
              <div style={{ background: '#111827', borderRadius: '10px', padding: '16px', border: '1px solid rgba(255,255,255,0.06)', display: 'flex', gap: '14px', alignItems: 'center', marginBottom: '10px' }}>
                ...
                <span style={{ background: 'rgba(0,208,132,0.12)', color: '#00D084', border: '1px solid rgba(0,208,132,0.25)', fontFamily: 'DM Sans, sans-serif', fontSize: '11px', fontWeight: 700, padding: '3px 8px', borderRadius: '100px', flexShrink: 0 }}>
                  Hot
                </span>
              </div>
              {DEALS.slice(1, 5).map(function(d) {
                return (
                  <div key={d.id} style={{ background: '#111827', borderRadius: '8px', padding: '10px 14px', border: '1px solid rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '8px' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexShrink: 0 }}>
                      ...
                      <span style={{ background: 'rgba(0,208,132,0.12)', color: '#00D084', border: '1px solid rgba(0,208,132,0.25)', fontFamily: 'DM Sans, sans-serif', fontSize: '10px', fontWeight: 700, padding: '2px 7px', borderRadius: '100px' }}>
              ...
              <Link href="/browse" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', background: '#00D084', color: '#0A0E1A', textDecoration: 'none', padding: '12px', borderRadius: '8px', fontFamily: 'DM Sans, sans-serif', fontSize: '13px', fontWeight: 700, letterSpacing: '0.06em', textTransform: 'uppercase', marginTop: '4px' }}>
        ...
        <div className="fade-up fade-up-5" style={{ display: 'flex', alignItems: 'center', gap: '12px', marginTop: '56px', paddingTop: '32px', borderTop: '1px solid rgba(255,255,255,0.06)', flexWrap: 'wrap' }}>
